          ...
          <div className="space-y-8">
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li><strong>Payment information:</strong> when you pay via M-Pesa (Paybill or Till), you send the payment directly through Safaricom's M-Pesa network. We store limited transaction metadata (amount, status, and the M-Pesa confirmation code if you provide one) but we never see or store your M-Pesa PIN.</li>
