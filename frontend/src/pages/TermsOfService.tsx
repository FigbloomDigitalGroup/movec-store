      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          <p className="text-gray-700 leading-relaxed mb-8">
            These Terms of Service ("Terms") govern your access to and use of the Starlink CCTV website, products, and services (the "Service"), operated in Nairobi, Kenya. By creating an account, placing an order, or otherwise using the Service, you agree to be bound by these Terms. If you do not agree, please do not use the Service.
          </p>
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700">
                To the fullest extent permitted by Kenyan law, Starlink CCTV shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the Service or products purchased through it. Our total liability for any claim relating to an order shall not exceed the amount you paid for the relevant order.
              </p>
            </section>
