          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li>We accept payment via M-Pesa Paybill, M-Pesa Till Number (Buy Goods), or cash on delivery.</li>
                <li>Paybill and Till payments are made manually from your phone — your order is marked "awaiting payment" until we confirm receipt of funds against our M-Pesa statement.</li>
            ...
            <section>
              ...
              <p className="text-gray-700">
                The Service integrates third-party providers, including Safaricom M-Pesa and delivery partners. We are not responsible for the acts, omissions, or service interruptions of these third parties, which are governed by their own terms.
              </p>
            </section>
