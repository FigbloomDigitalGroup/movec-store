      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 flex items-center gap-2">
            <FiMessageSquare className="text-blue-600" /> Customer Reviews & Moderation
          </h1>
          <p className="text-gray-500 text-sm mt-1">
            Review, approve, or reject customer feedback for products in your store.
          </p>
        </div>
        ...
        <div className="relative w-full md:w-72">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-xs text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:bg-white transition"
          />
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
          ...
          <select
            ...
            className="bg-gray-50 border border-gray-200 rounded-xl px-3 py-1.5 text-xs text-gray-700 font-semibold focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2 border-b border-gray-100 pb-3">
                      ...
                      {review.product && (
                        ...
                        >
                          <FiPackage size={13} className="text-blue-600" />
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="text-center">
                <h3 className="text-lg font-bold text-gray-900">Delete Product Review</h3>
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold text-xs py-2.5 rounded-xl transition"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 bg-red-600 hover:bg-red-700 text-white font-semibold text-xs py-2.5 rounded-xl transition shadow-sm"
                >
